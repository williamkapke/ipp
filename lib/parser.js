...
module.exports = function(buf) {
	...
	function readValue(tag, name){
		...
		switch (tag) {
			...
			//see https://github.com/williamkapke/ipp/issues/12
			case tags.novalue:
				if(length>0) {
					read(length);//ignore value
					console.log("The spec is not clear on how to handle tag " +tag+ ". Please open a github issue to help find a solution!");
				}
				return;
