...
const media = {
  ...
  'media type': ['bond', 'heavyweight', 'labels', 'letterhead', 'plain', 'pre-printed', 'pre-punched', 'recycled', 'transparency'],
  'input tray': [
    'bottom',
    'by-pass-tray',
    'envelope',
...
keywords['ipp-features-supported'] = setofKeyword(['document-object', 'ipp-everywhere', 'job-save', 'none', 'page-overrides', 'proof-print', 'subscription-object']);
...
keywords['job-hold-until'] = keywordName(['day-time', 'evening', 'indefinite', 'night', 'no-hold', 'second-shift', 'third-shift', 'weekend']);
...
keywords['job-sheets'] = keywordName(['first-print-stream-page', 'job-both-sheet', 'job-end-sheet', 'job-start-sheet', 'none', 'standard']);
...
keywords.media = keywordName([].concat(media['size name'], media['media name'], media['media type'], media['input tray'], media['envelope name']));
...
keywords['media-col-supported'] = setofKeyword(['media-bottom-margin', 'media-left-margin', 'media-right-margin', 'media-size-name', 'media-source', 'media-top-margin']);
keywords['media-color'] = keywordName(['blue', 'buff', 'goldenrod', 'gray', 'green', 'ivory', 'no-color', 'orange', 'pink', 'red', 'white', 'yellow']);
...
keywords['media-tooth'] = keywordName(['antique', 'calendared', 'coarse', 'fine', 'linen', 'medium', 'smooth', 'stipple', 'uncalendared', 'vellum']);
...
keywords['multiple-document-handling'] = keyword(['separate-documents-collated-copies', 'separate-documents-uncollated-copies', 'single-document', 'single-document-new-sheet']);
...
keywords['page-delivery'] = keyword(['reverse-order-face-down', 'reverse-order-face-up', 'same-order-face-down', 'same-order-face-up', 'system-specified']);
...
keywords['pdl-init-file-supported'] = setofKeyword(['pdl-init-file-entry', 'pdl-init-file-location', 'pdl-init-file-name']);
...
keywords['print-color-mode'] = keyword(['auto', 'bi-level', 'color', 'highlight', 'monochrome', 'process-bi-level', 'process-monochrome']);
...
keywords['print-rendering-intent'] = keyword(['absolute', 'auto', 'perceptual', 'relative', 'relative-bpc', 'saturation']);
...
keywords['uri-authentication-supported'] = setofKeyword(['basic', 'certificate', 'digest', 'negotiate', 'none', 'requesting-user-name']);
keywords['uri-security-supported'] = setofKeyword(['none', 'ssl3', 'tls']);
keywords['which-jobs'] = keyword(['aborted', 'all', 'canceled', 'completed', 'not-completed', 'pending', 'pending-held', 'processing', 'processing-stopped', 'proof-print', 'saved']);
...
keywords['xri-authentication-supported'] = setofKeyword(['basic', 'certificate', 'digest', 'none', 'requesting-user-name']);
