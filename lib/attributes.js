...
attributes["Job Template"] = {
  ...
  "finishings-col":                               collection({
    "baling":                                     collection({
      "baling-type":                              _(keyword, name),
      "baling-when":                              keyword
    }),
    "binding":                                    collection({
      "binding-reference-edge":                   keyword,
      "binding-type":                             _(keyword, name)
    }),
    "coating":                                    collection({
      "coating-sides":                            keyword,
      "coating-type":                             _(keyword, name)
    }),
    "covering":                                   collection({
      "covering-name":                            _(keyword, name)
    }),
    "finishing-template":                         _(keyword, name),
    "folding":                                    setof(collection({
      "folding-direction":                        keyword,
      "folding-offset":                           integer(0,MAX),
      "folding-reference-edge":                   keyword
    })),
    "imposition-template":                        _(keyword, name),
    "laminating":                                 collection({
      "laminating-sides":                         keyword,
      "laminating-type":                          _(keyword, name)
    }),
    "media-sheets-supported":                     rangeOfInteger(1, MAX),
    "media-size":                                 collection({
      "media-size-name":                          keyword
    }),
    "punching":                                   collection({
      "punching-locations":                       setof(integer(0,MAX)),
      "punching-offset":                          integer(0,MAX),
      "punching-reference-edge":                  keyword
    }),
    "stitching":                                  collection({
      "stitching-angle":                          integer(0,359),
      "stitching-locations":                      setof(integer(0,MAX)),
      "stitching-method":                         keyword,
      "stitching-offset":                         integer(0,MAX),
      "stitching-reference-edge":                 keyword
    }),
    "trimming":                                   setof(collection({
      "trimming-offset":                          integer(0,MAX),
      "trimming-reference-edge":                  keyword,
      "trimming-type":                            _(keyword, name),
      "trimming-when":                            keyword,
    })),
  }),
	"font-name-requested":                          name,
  "font-size-requested":                          integer(1,MAX),
...
attributes["Printer Description"] = {
  "baling-type-supported":                        setof(keyword, name),
  "baling-when-supported":                        setof(keyword),
  "binding-reference-edge-supported":             setof(keyword),
  "binding-type-supported":                       setof(keyword),
	"charset-configured":                           charset,
  "charset-supported":                            setof(charset),
  "coating-sides-supported":                      setof(keyword),
  "coating-type-supported":                       setof(keyword, name),
  ...
  "covering-name-supported":                      setof(keyword, name),
  ...
  "finishing-template-supported":                 setof(name, keyword),
  "finishings-col-database":                      setof(collection("Job Template","finishings-col")),
  ...
  "folding-direction-supported":                  setof(keyword),
  "folding-offset-supported":                     setof(_(integer(0,MAX), rangeOfInteger(0,MAX))),
  "folding-reference-edge-supported":             setof(keyword),
  ...
  "laminating-sides-supported":                   setof(keyword),
  "laminating-type-supported":                    setof(_(keyword, name)),
  ...
  "printer-finisher":                             setof(octetString),
  "printer-finisher-description":                 setof(text),
  "printer-finisher-supplies":                    setof(octetString),
  "printer-finisher-supplies-description":        setof(text),
  ...
  "punching-hole-diameter-configured":            integer(0,MAX),
  "punching-locations-supported":                 setof(_(integer(0,MAX), rangeOfInteger(0,MAX))),
  "punching-offset-supported":                    setof(_(integer(0,MAX), rangeOfInteger(0,MAX))),
  "punching-reference-edge-supported":            setof(keyword),
  ...
  "stitching-angle-supported":                    setof(_(integer(0,359), rangeOfInteger(0,359))),
  "stitching-locations-supported":                setof(_(integer(0,MAX), rangeOfInteger(0,MAX))),
  "stitching-method-supported":                   setof(keyword),
  "stitching-offset-supported":                   setof(_(integer(0,MAX), rangeOfInteger(0,MAX))),
  "subordinate-printers-supported":               setof(uri),
  "trimming-offset-supported":                    setof(_(integer(0,MAX), rangeOfInteger(0,MAX))),
  "trimming-reference-edge-supported":            setof(keyword),
  "trimming-type-supported":                      setof(keyword),
  "trimming-when-supported":                      setof(keyword),
