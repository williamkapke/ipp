...
function integer(min,max){
	...
	return { type:arguments.callee.name, min: min, max: max };
}
...
function boolean(){
	return { type:arguments.callee.name };
}
function charset(){
	return { type:arguments.callee.name, max: 63 };
}
function keyword(){
	return { type:arguments.callee.name, min:1, max:1023 };
}
...
function mimeMediaType(){
	return { type:arguments.callee.name, max: 255 };
}
function uri(max){
